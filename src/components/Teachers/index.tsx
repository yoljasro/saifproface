...
export const Teachers: React.FC = () => {
  ...
  const teachers: Teacher[] = [
    ...
    },
    {
      ...
      biografy: "Ведет прием, оказывая весь спектр терапевтический и ортопедических услуг. Это лечение кариеса, восстановление сильно разрушенных зубов, композитные и керамические накладки(основное направление), Эстетика: композитные и керамические виниры, проф.гигиена, съемное протезирование, несъемное протезирование: металлокремические, циркониевые коронки(одиночные имостовидные) ",
      teach: "С 2019 по 2024 гг. окончил Ташкентский Государственный Стоматологический Институт (стоматолог общей практики)",
      skill: "C 2021 по 2023 гг. Стоматологическая клиника L-dent С 2023 по н.в. Врач терапевт в клинике «abclinic.uz»14:35»",
      titleone: "Биография ",
      titletwo: "Образование",
      titlethree: "Стаж работы"
